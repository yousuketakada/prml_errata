...
if we regard the (differential) entropy~$\operatorname{H}[\cdot]$ as a functional,
...
aligned at the upper-left corner of $\mathbf{A}$.}
...
it is easy to see that the entropy can be obtained in the form~(B.82)
