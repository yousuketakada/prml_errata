...
after which we also discuss the difference between the two criteria for model selection, namely,
...
because it seems that the difference is, unfortunately, not well-recognized in PRML.
