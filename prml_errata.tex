...
This does not make sense because the right hand side of (10.152) is a lower bound to
the joint distribution~$p(\bm{\mathsf{t}}, \mathbf{w})$ and thus not dependent on
...
but \emph{not} by normalizing the right hand side of (10.152).
...
a lower bound to the joint distribution (the likelihood, in this case).
