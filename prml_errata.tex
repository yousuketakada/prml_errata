...
so that the left hand side of (2.275) should read
...
so that the left hand side of (B.19) should read
$\operatorname{cov}\left[\mu_j, \mu_k\right]$.
We should also add the condition~$j \neq k$ in order that (B.19) holds.
...
so that the left hand side of (B.57) should read
