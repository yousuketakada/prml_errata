...
\label{eq:Taylor_expansion_with_remainder_term}
\end{equation}
...
then the Taylor expansion~\eqref{eq:Taylor_expansion_with_remainder_term}
(up to the third order term) is given by
\begin{equation}
f(x \pm h) =
