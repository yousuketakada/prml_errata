...
regarding the shape of the Gaussian-gamma distribution..
...
Contours are plotted from $0.1$ to $0.5$ with a step of $0.1$.
For instance, the outermost contour (blue) corresponds to the density of $0.1$;
the innermost contour (red) to $0.5$.}
