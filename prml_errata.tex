...
\emph{measure theory} (see, e.g., \citet{Tao:MeasureTheory}),
...
we omit such ``measurable'' qualifiers for brevity in the rest of this report.}
subset~$\mathcal{X}_0 \subset \mathcal{X}$,
...
$\mathcal{Y}_0 = g^{-1}(\mathcal{X}_0)$
is again measurable and
we can make the change of variable~$x = g(y)$ as
\begin{align}
