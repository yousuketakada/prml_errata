...
the Jacobian matrix of $\mathbf{A}$ with respect to $\mathbf{U}$ is
...
the Jacobian matrix~$\partial\mathbf{U}/\partial\mathbf{R}$ is again lower triangular.
...
\end{align}
together with the result~\eqref{eq:jacobian_of_cholesky_decomposition} and the identities
\begin{align}
