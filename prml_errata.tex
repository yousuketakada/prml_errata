...
``If the function~$f(\cdot)$ is twice differentiable,
then the inequality condition~(1.114) is equivalent to
the requirement that the second derivative of $f(\cdot)$ be everywhere nonnegative.''
