...
Moreover,
(a) the generalization error measured by cross-validation and
(b) the model evidence (or the marginal likelihood)
are closely related but different criteria,
though, in practice, a high model evidence often implies a low generalization error.
For more (advanced) discussions, see \citet{Watanabe:WBIC}.
