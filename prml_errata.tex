...
we have that the expectation of the \emph{score function}
...
\end{equation}
where the expectation is taken with respect to $p\left(\mathbf{x}\middle|\bm{\theta}\right)$.%
\footnote{See (1.37) for the definition of
the \emph{conditional expectation}~$\mathbb{E}_x \left[ \cdot \middle| y \right]$.}
