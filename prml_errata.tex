...
An equivalent of (1.115) in terms of expectation can be derived as follows.

\parhead{Jensen's inequality in terms of expectation}
In order to interpret (1.115) probabilistically,
we should rather introduce another set of underlying random variables~$\mathbf{z}$
