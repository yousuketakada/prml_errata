...
Finally, I would like to thank those who have kindly informed me of yet more errata
incorporated here.
I welcome all comments and suggestions regarding this report;
please send me any such feedback via email or, preferably,
by creating an issue or a pull request at the GitHub project page
\begin{center}
...
the restricted proof of (C.22) in terms of the eigenvalue decomposition
so as to use the \emph{singular value decomposition} or
SVD~\eqref{eq:singular_value_decomposition}
in order to show (C.22) for general $\mathbf{A}$ such that $\operatorname{det}(\mathbf{A}) \neq 0$
(I leave the detail of this proof as an exercise for the reader).
However, the proof in terms of the \emph{Jacobi's formula}~\eqref{eq:Jacobi_formula},
to be presented here,
is more straightforward than the one in terms of the SVD.}
...
\end{equation}
(beware that the superscript~$(ji)$ of $\mathbf{A}^{(ji)}$ is not $(ij)$)
...
\end{equation}
(consult a linear algebra textbook),
