...
can also be written in terms of the univariate gamma function~(1.141) as
\begin{equation}
\Gamma_D \left(\frac{\nu}{2}\right) =
...
With this identity~\eqref{eq:multivariate_gamma_function_in_terms_of_univariate_gamma_function},
we can simplify the normalization constant~(B.79) of the Wishart distribution in the form
\begin{equation}
B(\mathbf{W}, \nu)^{-1} =
2^{\nu D/2}
\left|\mathbf{W}\right|^{\nu/2}
