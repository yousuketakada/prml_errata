...
\section*{Preface}
This report communicates some more errata for \emph{Pattern Recognition and Machine Learning}
or \emph{PRML} by \citet*{Bishop:PRML}
...
So I refer to Version~2 of the errata~\citep{Svensen:PRML_errata}.}
...
this report also includes small typographical errors as well.

Although PRML is arguably such a great textbook in the machine learning field
that it is extremely helpful and easier to understand than any other similar account,
there are a few subtleties readers might have hard time to appreciate.
In hope to help them get out of struggle or become more confident about important concepts,
I have also included in this report some comments and suggestions for improving the readability,
which I would have liked to have when I first read PRML.

Note also that the readers of the Japanese edition of PRML will find its
\href{http://ibisforest.org/index.php?PRML}{support page} useful.
Along with other information,
it lists errata specific to the Japanese edition as well as
some additional errata for the English edition,
some of which have also been included in this report for the reader's convenience.
