...
Paragraph~3:
Note that
the \emph{Akaike information criterion} (AIC) and
the Schwartz's \emph{Bayesian information criterion} (BIC)
have different goals and thus are different criteria for model selection.
...
and the predictive~(3.58) over $t$ given $\bm{\mathsf{t}}$ will be
