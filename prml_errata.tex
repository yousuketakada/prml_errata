...
we see that the approximate posterior~(10.203) is given by (10.212); and
the approximate model evidence~(10.208) by
\begin{equation}
p(\mathcal{D}) \approx
...
where $B$ is given by \eqref{eq:EP_clutter_B}; and
$v, \mathbf{m}$ are replaced by $v^{\text{new}}, \mathbf{m}^{\text{new}}$.
