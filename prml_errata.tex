...
As the distributions over $\mathbf{w}$ and $\bm{\mathsf{t}}$ have been approximated in
\eqref{eq:posterior_for_RVM_classification} and (7.114), respectively,
we assume that the distribution over $\widehat{\bm{\mathsf{t}}}$
can also be approximated by the Laplace approximation.
Pretending that such Gaussian approximations are exact and
