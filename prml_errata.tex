...
given by\footnote{The multivariate gamma function is defined as
\begin{equation}
...
One can see that \eqref{eq:multivariate_gamma_definition} reduces to
the (univariate) gamma function~(1.141) when $D=1$.}
\begin{equation}
\Gamma_D \left(\frac{\nu}{2}\right) =
