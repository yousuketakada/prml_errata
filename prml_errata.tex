...
in the definition of the \emph{big O notation}.
With the original, uncorrected definition in PRML,
we would also have, say, $g(x) = 3 x^2 + 2 = O(x)$
because $\left|x/g(x)\right|$ is bounded as $x \to \infty$,
which is surely not what the author has intended.
