...
The \emph{responsibility}~$\gamma_k$ given by (9.13) can also be found directly by
inspecting the functional form of the joint distribution
\begin{equation}
...
unnormalized probabilities (responsibilities) as shown in
\eqref{eq:categorical_distribution_w_unnormalized_mu}.
