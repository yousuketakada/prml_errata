...
\sqrt{\bm{\varepsilon}^{\operatorname{T}}\bm{\varepsilon}}$ denotes
the norm of a vector~$\bm{\varepsilon}$.
...
\parhead{Vector derivatives identities}
...
(with respect to some parameters on which the errors~$\bm{\varepsilon}$ depend nonlinearly)
are evaluated as
\begin{align}
