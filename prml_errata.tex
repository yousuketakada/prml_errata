...
Equation~(2.160): The extra space between $\mathcal{N}\left(x\middle|\mu,  (\eta \lambda)^{-1}\right )$ and $\operatorname{Gam}\left(\eta \middle| \nu /2, \nu /2\right )$ should be removed to be consistent with other equations, such as (2.161) and (2.158).
...
$\widetilde{\mathbf{w}}^{\operatorname{T}} = (w_0, \mathbf{w}^{\operatorname{T}})$
and
$\widetilde{\mathbf{x}}^{\operatorname{T}} = (x_0, \mathbf{x}^{\operatorname{T}})$.
