...
I welcome all comments, questions, and suggestions about this report.
Please feel free to send any such feedback to me via email or, preferably,
...
\erratum{Page~266}
Equation~(5.132):
The third occurrence of the superscript~$T$ should be an upright $\operatorname{T}$.
...
so that (7.112) does not represent an explicit solution and should thus be best removed.
