...
\erratum{Page~697}
Equation~(C.17):
The definition~(C.17) of the derivative of a scalar with respect to a vector clearly contradicts
(C.16) and (C.18).
...
\end{equation}
Since the chain rule~\eqref{eq:chain_rule_for_gradient} is so handy
