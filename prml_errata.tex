...
this effectively leads to insufficient regularization and thus over-fitting.
...
although, in practice, a high model evidence often tends to imply a low generalization error and
vice versa.
