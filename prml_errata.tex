...
and also \citet{Tao:MeasureTheory} for an introduction to \emph{Lebesgue integration}),
...
The second edition of ``An Introduction to Probability Theory and Its Applications, Volume~2''
by Feller was published in 1971
(\emph{not} 1966, which is the year in which the first edition was published).
