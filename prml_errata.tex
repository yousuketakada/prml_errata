...
\end{equation}
One can show that,
if an isotropic scale matrix~$\mathbf{W} = W\mathbf{I}$ is used, which is common in practice,
the resulting multivariate Student's t-distribution is also isotropic and,
up to some reparameterization, the same distribution can be obtained also by marginalizing over
