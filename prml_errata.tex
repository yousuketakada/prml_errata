...
\erratum{Page~690}
Equation~(B.54):
I have found it helpful to identify the functional form of this distribution in,
e.g., the posterior distribution for the Gaussian mixture model of Section~9.2
if it is noted that the distribution can also be written in terms of unnormalized probabilities
...
\end{equation}
Thus, we have $\mu_k = C(\tilde{\bm{\mu}}) \tilde{\mu}_k$.
