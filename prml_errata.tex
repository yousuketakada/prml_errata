...
e.g., too expressive an model that would make terribly wrong predictions very confidently;
...
e.g., the order~$M$ of the polynomial function~(1.1) is large compared to
the size of the training data set as we have seen in Section~1.1.
