...
It seems that something strange must have happened in the third (2009) printing,
leading to some spacing issues especially where a sentence ends with a reference number
such as ``Figure~1.27.''
