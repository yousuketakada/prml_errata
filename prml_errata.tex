...
\erratum{Page~705}
The last paragraph:
It is not so straightforward to extend the results obtained here to
a multidimensional variable~$\mathbf{x} \in \mathbb{R}^{D}$.
Although such a multidimensional extension is not required in PRML,
it is useful in some form of constrained optimization.
Here, I would like to present one.
% TODO
