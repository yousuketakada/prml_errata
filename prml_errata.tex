...
Recall that we have defined $0 \log_2 0 = 0$ or, equivalently, $0 \ln 0 = 0$
so that the entropy in ``bits'' given by (1.93) or
that in ``nats'' given by \eqref{eq:entropy_in_nats}
is well-defined.}
