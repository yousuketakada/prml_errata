...
\end{equation}
Integrating the second term of \eqref{eq:first_order_variation_of_E_wrt_u_in_eta_before_expansion}
by making use of
...
can be seen as the inner product between
...
the variation~$\delta E[u; \eta]$ vanishes in any direction~$\eta(\mathbf{x})$ and
