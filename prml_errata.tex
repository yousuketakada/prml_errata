...
\erratum{Page~698}
Equation~(C.20):
It should be pointed out in advance that the Jacobian~$\partial\mathbf{A}/\partial x$ of
...
\end{equation}
which is analogous to the Jacobian~(C.18) of a vector with respect to a vector in that
...
\end{equation}
which should also be pointed out.
