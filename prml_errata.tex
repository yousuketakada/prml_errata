...
\end{align}
respectively, where we have made the subscript~$\bm{\theta}$ of the gradient operators implicit.
...
(or, equivalently, the number of rows of the matrix~$\mathbf{R}$).\footnote{%
One can see that
the second term in the right hand side of \eqref{eq:gradient_of_matrix_vector_product_general},
i.e., the gradient through $\mathbf{R}$, follows from
\begin{equation}
...
made use of the transpose of the Kronecker product~\citep{MagnusNeudecker:MDC}
\begin{equation}
