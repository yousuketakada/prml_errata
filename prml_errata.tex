...
\end{equation}
where we have used the gradient~\eqref{eq:gradient_of_scalar_wrt_matrix} and
assumed that $\mathbf{O}$ is a zero matrix.
...
-\frac{1}{2} \sum_{n=1}^{N} \sum_{i=1}^{D} \frac{y_{ni}^{2}}{\lambda_i}
+ \text{const}
