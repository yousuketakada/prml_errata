...
\end{equation}
where the expectation~$\mathbb{E}_\mathbf{x} \left[ \cdot \middle| \bm{\theta} \right]$ is
a \emph{conditional expectation}~(1.37) and
is taken with respect to $p\left(\mathbf{x}\middle|\bm{\theta}\right)$.
