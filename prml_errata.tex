...
\erratum{Page~279}
Equation~(5.167):
The conditioning on $\mathcal{D}$ or other variables for an approximate distribution
does not make sense (unless properly defined) and
should be removed or specified as parameters so that the left hand side of (5.167) reads
