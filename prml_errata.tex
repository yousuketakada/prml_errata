...
Note however that we can omit the subscripts~$\mathbf{Z}$ of
the expectations~$\mathbb{E}_{\mathbf{Z}}[\cdot]$ in (10.107)
...
Again, note that we can safely omit the subscripts~$\mathbf{Z}$ of
