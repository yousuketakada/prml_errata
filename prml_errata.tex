...
\parhead{Maximum likelihood for the multivariate Gaussian.}
...
\parhead{The log expectation of the gamma distribution.}
...
\parhead{The log minus digamma function.}
