...
the identity~\eqref{eq:expected_score_function_vanishes} as discussed in the following.
...
unnormalized probabilities~$\widetilde{\mu}_k$ for which we do not have the sum-to-one constraint.
